<div
    ...
    id="conversation"  class="flex flex-col gap-3 p-2.5 overflow-y-auto  flex-grow overscroll-contain overflow-x-hidden w-full my-auto">
        ...
        <div @class([
            ...
            <div @class(['flex flex-wrap text-[15px]  rounded-xl p-2.5 flex flex-col bg-[#f6f6f8fb]',
    ...
    <footer class="shrink-0 z-10 bg-white inset-x-0">
        ...
        <div class=" p-2 border-t">
          ...
          <div class="grid grid-cols-12">
              ...
              <button x-bind:disabled="!(body && body.trim())" class="col-span-2" type='submit'>
                  Send
              </button>
          </div>
      </form>
